...
public class ItemController {
	...
	@ResponseBody
	public Map<String, Object> getItems(String order,int page,String second,String skin,String age,String problem,String gender){
	...
	@ResponseBody
	public Map<String, Object> ajaxItemReviewList(@PathVariable int pageNo, String order, int itemNo,int filterScore, String reviewTypeStr, int loginUser){
